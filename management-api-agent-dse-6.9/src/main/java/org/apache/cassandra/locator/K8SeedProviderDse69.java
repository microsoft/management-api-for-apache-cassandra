...
public class K8SeedProviderDse69 implements SeedProvider {
  private static final Logger logger = LoggerFactory.getLogger(K8SeedProviderDse69.class);

  public K8SeedProviderDse69() {}
