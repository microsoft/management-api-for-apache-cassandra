...
import org.apache.cassandra.locator.K8SeedProviderDse69;
...
import org.apache.cassandra.transport.UnixSocketServerDse69;
...
public class DseAPI69 implements CassandraAPI {
  private static final Logger logger = LoggerFactory.getLogger(DseAPI69.class);

  private static final Supplier<SeedProvider> seedProvider =
      Suppliers.memoize(K8SeedProviderDse69::new)::get;
    ...
    try {
      ...
      for (Range<Token> range : tokenRanges) {
        ...
        List<InetAddress> endpoints =
            mockStrategy.calculateNaturalEndpoints(midpoint, tokenMetadata);
  ...
  public ChannelInitializer<Channel> makeSocketInitializer(
    ...
    return UnixSocketServerDse69.makeSocketInitializer(connectionTracker);
  }
  ...
  public Object handleRpcResult(Callable<Object> rpcResult) {
    return RxThreads.subscribeOnIo(
        Single.defer(() -> Single.fromCallable(rpcResult)), TPCTaskType.UNKNOWN);
  }
