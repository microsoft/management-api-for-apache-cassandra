...
public class K8SeedProvider4x implements SeedProvider {
  private static final Logger logger = LoggerFactory.getLogger(K8SeedProvider4x.class);

  public K8SeedProvider4x() {}
