...
public class ObjectSerializer3x<T> implements ObjectSerializer<T> {
   ...
   */
  public ObjectSerializer3x(Class<T> clazz, Type genericType) {
    serializers =
        GenericSerializer3x.simpleType(genericType)
            ? ImmutableSortedMap.<String, FieldSerializer>of(
                "result", new FieldSerializer(GenericSerializer3x.getType(genericType), x -> x))
  ...
  public ObjectSerializer3x(Class<T> clazz) {
    this(clazz, clazz);
  }
