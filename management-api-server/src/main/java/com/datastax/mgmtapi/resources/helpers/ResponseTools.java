...
public class ResponseTools {
  ...
  public static String getSingleRowStringResponse(
      final File dbUnixSocketFile, CqlService cqlService, String query, Object... params)
  ...
  public static Object getSingleRowResponse(
      final File dbUnixSocketFile, CqlService cqlService, String query, Object... params)
      throws ConnectionClosedException {
    Row row = getRow(dbUnixSocketFile, cqlService, query, params);
  ...
  private static Row getRow(
      File dbUnixSocketFile, CqlService cqlService, String query, Object[] params)
      throws ConnectionClosedException {
    ResultSet rs;
