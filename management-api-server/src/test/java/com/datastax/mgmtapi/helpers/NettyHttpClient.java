...
public class NettyHttpClient {
  ...
  public NettyHttpClient(URL endpoint, File clientCaFile, File clientCertFile, File clientKeyFile)
      throws SSLException {
    ...
    try {
      ...
      while (tries++ < 5) {
        ...
        try {
          client =
              b.connect(endpoint.getHost(), endpoint.getPort()).syncUninterruptibly().channel();
          return;
        } catch (Throwable t) {
        }
      }
