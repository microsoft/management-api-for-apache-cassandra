...
public class ObjectSerializerDse68<T> implements ObjectSerializer<T> {
   ...
   */
  public ObjectSerializerDse68(Class<T> clazz, Type genericType) {
    serializers =
        GenericSerializerDse68.simpleType(genericType)
            ? ImmutableSortedMap.<String, FieldSerializer>of(
                "result", new FieldSerializer(GenericSerializerDse68.getType(genericType), x -> x))
  ...
  public ObjectSerializerDse68(Class<T> clazz) {
    this(clazz, clazz);
  }
