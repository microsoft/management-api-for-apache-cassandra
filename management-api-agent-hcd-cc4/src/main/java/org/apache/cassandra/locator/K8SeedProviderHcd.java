...
public class K8SeedProviderHcd implements SeedProvider {
  private static final Logger logger = LoggerFactory.getLogger(K8SeedProviderHcd.class);

  public K8SeedProviderHcd() {}
