...
import org.apache.cassandra.locator.K8SeedProvider41x;
...
import org.apache.cassandra.transport.UnixSocketServer41x;
import org.apache.cassandra.utils.FBUtilities;
import org.apache.cassandra.utils.JVMStabilityInspector;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class CassandraAPI41x implements CassandraAPI {
  private static final Logger logger = LoggerFactory.getLogger(CassandraAPI41x.class);

  private static final Supplier<SeedProvider> seedProvider =
      Suppliers.memoize(() -> new K8SeedProvider41x());
  ...
  public ChannelInitializer<Channel> makeSocketInitializer(
    ...
    return UnixSocketServer41x.makeSocketInitializer(connectionTracker);
  }
  ...
  public RpcStatementShim makeRpcStatement(String method, String[] params) {
    return new RpcStatement41x(method, params);
  }
