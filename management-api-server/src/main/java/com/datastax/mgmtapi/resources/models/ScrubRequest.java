...
public class ScrubRequest implements Serializable {
  ...
  @JsonCreator
  public ScrubRequest(
      @JsonProperty("disable_snapshot") boolean disableSnapshot,
      @JsonProperty("skip_corrupted") boolean skipCorrupted,
      @JsonProperty("check_data") boolean checkData,
      @JsonProperty("reinsert_overflowed_ttl") boolean reinsertOverflowedTTL,
