 ...
 *
 * <p>- sourceLabels: [subsystem, server] separator: "@" regex: "kata@webserver" action: "drop"
 *
 * <p>Like Prometheus, the metric name is available as source_label "__name__" and the original
 * Cassandra metric name is available as "__origname__"
 */
