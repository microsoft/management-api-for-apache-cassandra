...
public class CassandraMetricsTools {
  ...
  public static final String INSTANCE_LABEL_NAME = "instance";
  public static final String RACK_LABEL_NAME = "rack";
  public static final String HOSTID_LABEL_NAME = "host";
  public static final String BUCKET_LABEL_NAME = "le";
  public static final String QUANTILE_LABEL_NAME = "quantile";

  public static final String CLUSTER_NAME = getClusterName();
  public static final String RACK_NAME = getRack();
  public static final String DATACENTER_NAME = getDatacenter();
  public static final String INSTANCE_NAME = getBroadcastAddress().getHostAddress();
  public static final String HOST_ID = getHostId();
  public static final String INF_BUCKET = "+Inf";
  ...
  public static final List<String> DEFAULT_LABEL_NAMES =
      Arrays.asList(
          ...
          RACK_LABEL_NAME);
  public static final List<String> DEFAULT_LABEL_VALUES =
      Arrays.asList(HOST_ID, INSTANCE_NAME, CLUSTER_NAME, DATACENTER_NAME, RACK_NAME);

  public static final double[] PRECOMPUTED_QUANTILES =
      new double[] {0.5, 0.75, 0.95, 0.98, 0.99, 0.999};

  // This is to reduce allocations
  public static final String[] PRECOMPUTED_QUANTILES_TEXT =
      new String[PRECOMPUTED_QUANTILES.length];
  ...
  public static String getRack() {
    ...
    try {
      return (String)
          IEndpointSnitch.class
              .getMethod("getRack", InetAddress.class)
              .invoke(DatabaseDescriptor.getEndpointSnitch(), getBroadcastAddress());
  ...
  public static String getDatacenter() {
    ...
    try {
      return (String)
          IEndpointSnitch.class
              .getMethod("getDatacenter", InetAddress.class)
              .invoke(DatabaseDescriptor.getEndpointSnitch(), getBroadcastAddress());
    } catch (IllegalAccessException
        | IllegalArgumentException
        | InvocationTargetException
