...
public class K8OperatorResourcesTest {
  ...
  public void testSeedReload() throws Exception {
    ...
    when(mockRow.getList("result", String.class)).thenReturn(ImmutableList.of("127.0.0.1"));
  ...
  public void testDecommission() throws Exception {
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(), eq("CALL NodeOps.decommission(?, ?)"), eq(true), eq(false));
  }
  ...
  public void testDecommissionAsync() throws Exception {
    ...
    verify(context.cqlService, timeout(500))
        .executePreparedStatement(any(), eq("CALL NodeOps.decommission(?, ?)"), eq(true), eq(true));
  }
  ...
  public void testDecommissionMissingValue() throws Exception {
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(), eq("CALL NodeOps.decommission(?, ?)"), eq(false), eq(false));
  }
  ...
  public void testRebuild() throws Exception {
    ...
    when(context.cqlService.executePreparedStatement(any(), anyString(), eq(srcDc)))
        .thenReturn(mockResultSet);
    ...
    verify(context.cqlService, timeout(500))
        .executePreparedStatement(any(), eq("CALL NodeOps.rebuild(?)"), eq(srcDc));
  }
  ...
  public void testSetCompactionThroughput() throws Exception {
    ...
    MockHttpRequest request =
        MockHttpRequest.post(ROOT_PATH + "/ops/node/compaction?value=" + value);
  ...
  public void testAssassinate() throws Exception {
    ...
    Context context = setup();
    MockHttpRequest request =
        MockHttpRequest.post(ROOT_PATH + "/ops/node/assassinate?address=" + address);
    when(context.cqlService.executePreparedStatement(any(), anyString(), eq(true)))
        .thenReturn(null);
  ...
  public void testSetLoggingLevel() throws Exception {
    ...
    MockHttpRequest request =
        MockHttpRequest.post(
            String.format(
                ROOT_PATH + "/ops/node/logging?target=%s&rawLevel=%s", classQualifier, rawLevel));
    when(context.cqlService.executePreparedStatement(any(), anyString(), eq(true)))
        .thenReturn(null);
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(), eq("CALL NodeOps.setLoggingLevel(?, ?)"), eq(classQualifier), eq(rawLevel));
  }
  ...
  public void testSetLoggingLevel_MissingClassQualifier() throws Exception {
    ...
    Context context = setup();
    MockHttpRequest request =
        MockHttpRequest.post(String.format(ROOT_PATH + "/ops/node/logging?rawLevel=%s", rawLevel));
    when(context.cqlService.executePreparedStatement(any(), anyString(), eq(true)))
        .thenReturn(null);
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(), eq("CALL NodeOps.setLoggingLevel(?, ?)"), eq(EMPTY), eq(rawLevel));
  }
  ...
  public void testSetLoggingLevel_MissingRawLevel() throws Exception {
    ...
    MockHttpRequest request =
        MockHttpRequest.post(
            String.format(ROOT_PATH + "/ops/node/logging?target=%s", classQualifier));
    when(context.cqlService.executePreparedStatement(any(), anyString(), eq(true)))
        .thenReturn(null);
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(), eq("CALL NodeOps.setLoggingLevel(?, ?)"), eq(classQualifier), eq(EMPTY));
  }
  ...
  public void testTruncateHints_WithHost() throws Exception {
    ...
    Context context = setup();
    MockHttpRequest request =
        MockHttpRequest.post(ROOT_PATH + "/ops/node/hints/truncate?host=" + host);
  ...
  public void testScrub() throws Exception {
    ScrubRequest scrubRequest =
        new ScrubRequest(true, true, true, true, 2, "keyspace", Arrays.asList("table1", "table2"));
    ...
    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.scrub(?, ?, ?, ?, ?, ?, ?, ?)"), any());
  }

  @Test
  public void testScrub_MissingTables() throws Exception {
    ScrubRequest scrubRequest = new ScrubRequest(true, true, true, true, 2, "keyspace", null);
  ...
  public void testScrub_MissingKeyspace() throws Exception {
    ScrubRequest scrubRequest =
        new ScrubRequest(true, true, true, true, 2, null, Arrays.asList("table1", "table2"));
  ...
  public void testUpgradeSSTables() throws Exception {
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(),
            eq("CALL NodeOps.upgradeSSTables(?, ?, ?, ?, ?)"),
            eq(keyspaceRequest.keyspaceName),
            eq(true),
            eq(keyspaceRequest.jobs),
            any(),
            anyBoolean());
  }
  ...
  public void testUpgradeSSTables_MissingKeyspace() throws Exception {
    KeyspaceRequest keyspaceRequest =
        new KeyspaceRequest(1, null, Arrays.asList("table1", "table2"));
  ...
  private MockHttpResponse getJobStatusWithId(Context context, String path)
      throws URISyntaxException {
    MockHttpRequest request =
        MockHttpRequest.get(ROOT_PATH + path)
  ...
  public void testCleanup() throws Exception {
    ...
    verify(context.cqlService, timeout(500))
        .executePreparedStatement(
            any(), eq("CALL NodeOps.forceKeyspaceCleanup(?, ?, ?, ?)"), any());
  }

  @Test
  public void testCleanup_SystemKeyspace() throws Exception {
    KeyspaceRequest keyspaceRequest =
        new KeyspaceRequest(1, "system", Arrays.asList("table1", "table2"));
  ...
  public void testCleanup_MissingTables() throws Exception {
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(),
            eq("CALL NodeOps.forceKeyspaceCleanup(?, ?, ?, ?)"),
            any(),
            eq(keyspaceRequest.keyspaceName),
            any(),
            anyBoolean());
  ...
  public void testCompact() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(
            false, false, null, null, "keyspace", null, Arrays.asList("table1", "table2"));
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(),
            eq("CALL NodeOps.forceKeyspaceCompaction(?, ?, ?, ?)"),
            eq(compactRequest.splitOutput),
            eq(compactRequest.keyspaceName),
            any(),
            anyBoolean());
  }
  ...
  public void testCompact_WithToken() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(
            false, false, "1", "2", "keyspace", null, Arrays.asList("table1", "table2"));
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(),
            eq("CALL NodeOps.forceKeyspaceCompactionForTokenRange(?, ?, ?, ?, ?)"),
            eq(compactRequest.keyspaceName),
            eq(compactRequest.startToken),
            eq(compactRequest.endToken),
            any(),
            anyBoolean());
  }
  ...
  public void testCompact_UserDefined() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(
            false, true, null, null, "keyspace", Arrays.asList("file1", "file2"), null);
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(), eq("CALL NodeOps.forceUserDefinedCompaction(?, ?)"), any(), anyBoolean());
  }

  @Test
  public void testCompact_UserDefinedMissingFile() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(false, true, null, null, "keyspace", null, null);
  ...
  public void testCompact_SplitOutputAndToken() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(
            true, true, "1", "2", "keyspace", null, Arrays.asList("table1", "table2"));
  ...
  public void testCompact_UserDefinedAndToken() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(
            false, true, "1", "2", "keyspace", null, Arrays.asList("table1", "table2"));
  ...
  public void testCompact_MissingTables() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(false, false, null, null, "keyspace", null, null);
  ...
  public void testCompact_MissingKeyspace() throws Exception {
    CompactRequest compactRequest =
        new CompactRequest(false, false, null, null, null, null, Arrays.asList("table1", "table2"));
  ...
  public void testGarbageCollect() throws Exception {
    ...
    MockHttpResponse response =
        postWithBody(
            "/ops/tables/garbagecollect?tombstoneOption=" + tombstoneOption,
            requestAsJSON,
            context);
  ...
  public void testGarbageCollect_BadTombstoneOption() throws Exception {
    KeyspaceRequest keyspaceRequest =
        new KeyspaceRequest(1, "foo", Arrays.asList("table1", "table2"));
  ...
  public void testRefresh() throws Exception {
    ...
    MockHttpRequest request =
        MockHttpRequest.post(
            ROOT_PATH
                + String.format(
                    "/ops/keyspace/refresh?keyspaceName=%s&table=%s&resetLevels=%s",
                    keyspaceName, table, resetLevels));
    when(context.cqlService.executePreparedStatement(any(), anyString())).thenReturn(null);
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            any(), eq("CALL NodeOps.loadNewSSTables(?, ?)"), eq(keyspaceName), eq(table));
  }
  ...
  public void testRefresh_MissingTable() throws Exception {
    ...
    MockHttpRequest request =
        MockHttpRequest.post(
            ROOT_PATH
                + String.format(
                    "/ops/keyspace/refresh?keyspaceName=%s&resetLevels=%s",
                    keyspaceName, resetLevels));
    when(context.cqlService.executePreparedStatement(any(), anyString())).thenReturn(null);
  ...
  public void testRefresh_MissingKeyspace() throws Exception {
    ...
    MockHttpRequest request =
        MockHttpRequest.post(
            ROOT_PATH
                + String.format(
                    "/ops/keyspace/refresh?cfName=%s&resetLevels=%s", cfName, resetLevels));
    when(context.cqlService.executePreparedStatement(any(), anyString())).thenReturn(null);
  ...
  public void testGetStreamInfo() throws Exception {
    ...
    result.add(
        ImmutableMap.of("987-654-321-uuid", session1Results, "123-456-789-uuid", session2Results));
  ...
  public void testCreatingKeyspace() throws IOException, URISyntaxException {
    CreateOrAlterKeyspaceRequest keyspaceRequest =
        new CreateOrAlterKeyspaceRequest(
            "myKeyspace",
            Arrays.asList(new ReplicationSetting("dc1", 3), new ReplicationSetting("dc2", 3)));
    ...
    String keyspaceRequestAsJSON =
        WriterUtility.asString(keyspaceRequest, MediaType.APPLICATION_JSON);
    MockHttpResponse response =
        postWithBody("/ops/keyspace/create", keyspaceRequestAsJSON, context);

    assertThat(response.getStatus()).isEqualTo(HttpStatus.SC_OK);
    assertThat(response.getContentAsString()).contains("OK");

    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.createKeyspace(?, ?)"), any());
  }
  ...
  public void testCreatingEmptyKeyspaceShouldFail() throws IOException, URISyntaxException {
    ...
    assertThat(response.getContentAsString())
        .contains("Keyspace creation failed. Non-empty 'keyspace_name' must be provided");
  }

  @Test
  public void testCreatingEmptyReplicationSettingsShouldFail()
      throws IOException, URISyntaxException {
    CreateOrAlterKeyspaceRequest keyspaceRequest =
        new CreateOrAlterKeyspaceRequest("TestKeyspace", Collections.emptyList());
    ...
    assertThat(response.getStatus()).isEqualTo(HttpStatus.SC_BAD_REQUEST);
    assertThat(response.getContentAsString())
        .contains("Keyspace creation failed. 'replication_settings' must be provided");
  }
  ...
  public void testAlteringKeyspace() throws IOException, URISyntaxException {
    ...
    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.alterKeyspace(?, ?)"), any());
  }
  ...
  public void testAlteringEmptyKeyspaceShouldFail() throws IOException, URISyntaxException {
    ...
    assertThat(response.getStatus()).isEqualTo(HttpStatus.SC_BAD_REQUEST);
    assertThat(response.getContentAsString())
        .contains("Altering Keyspace failed. Non-empty 'keyspace_name' must be provided");
  }

  @Test
  public void testAlteringEmptyReplicationSettingsShouldFail()
      throws IOException, URISyntaxException {
    CreateOrAlterKeyspaceRequest keyspaceRequest =
        new CreateOrAlterKeyspaceRequest("TestKeyspace", Collections.emptyList());
    ...
    assertThat(response.getStatus()).isEqualTo(HttpStatus.SC_BAD_REQUEST);
    assertThat(response.getContentAsString())
        .contains("Altering Keyspace failed. 'replication_settings' must be provided");
  }

  private MockHttpResponse postWithBody(String path, String body, Context context)
      throws URISyntaxException {
    MockHttpRequest request =
        MockHttpRequest.post(ROOT_PATH + path)
  ...
  private MockHttpResponse postWithBodyFullPath(String path, String body, Context context)
      throws URISyntaxException {
    MockHttpRequest request =
  ...
  public void testTakeSnapshotWithKeyspaceAndKeyspaceTablesShouldFail() throws Exception {
    TakeSnapshotRequest takeSnapshotRequest =
        new TakeSnapshotRequest(
            "testSnapshot",
            Arrays.asList("testKeyspace"),
            null,
            null,
            Arrays.asList("testKeyspace.testTable"));

    Context context = setup();

    when(context.cqlService.executePreparedStatement(any(), anyString())).thenReturn(null);

    String takeSnapshotRequestAsJSON =
        WriterUtility.asString(takeSnapshotRequest, MediaType.APPLICATION_JSON);
    MockHttpResponse response =
        postWithBody("/ops/node/snapshots", takeSnapshotRequestAsJSON, context);

    assertThat(response.getStatus()).isEqualTo(HttpStatus.SC_BAD_REQUEST);
    assertThat(response.getContentAsString())
        .isEqualTo("When specifying keyspace_tables, specifying keyspaces is not allowed");
  }

  @Test
  public void testTakeSnapshotWithTableNameAndNoKeyspaceShouldFail() throws Exception {
    TakeSnapshotRequest takeSnapshotRequest =
        new TakeSnapshotRequest("testSnapshot", null, "testTable", null, null);
    ...
    assertThat(response.getStatus()).isEqualTo(HttpStatus.SC_BAD_REQUEST);
    assertThat(response.getContentAsString())
        .isEqualTo("Exactly 1 keyspace must be specified when specifying table_name");
  }
  ...
  public void testTakeSnapshotWithTableNameAndMultipleKeyspacesShouldFail() throws Exception {
    TakeSnapshotRequest takeSnapshotRequest =
        new TakeSnapshotRequest(
            "testSnapshot", Arrays.asList("test_ks1", "test_ks2"), "testTable", null, null);
  ...
  public void testTakeSnapshot() throws Exception {
    ...
    assertThat(response.getStatus()).isEqualTo(HttpStatus.SC_OK);
    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.takeSnapshot(?, ?, ?, ?, ?)"), any());
  }
  ...
  public void testGetSnapshotDetails() throws Exception {
    ...
    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.getSnapshotDetails(?, ?)"), any());
  }
  ...
  public void testDeleteSnapshotDetails() throws Exception {
    ...
    Assert.assertEquals(HttpStatus.SC_OK, response.getStatus());
    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.clearSnapshots(?, ?)"), any());
  }
  ...
  public void testGetKeyspacesWithFilter() throws Exception {
    ...
    String filteredResultAsJSON =
        WriterUtility.asString(filteredResult, MediaType.APPLICATION_JSON);
    when(mockRow.getList(0, String.class)).thenReturn(result);
    ...
    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.getKeyspaces()"), any());
  }
  ...
  public void testGetReplication() throws Exception {
    ...
    MockHttpRequest request =
        MockHttpRequest.get(ROOT_PATH + "/ops/keyspace/replication?keyspaceName=ks1");
    when(context.cqlService.executePreparedStatement(any(), anyString(), anyString()))
        .thenReturn(mockResultSet);
    when(mockResultSet.one()).thenReturn(mockRow);
    ...
    Map<String, String> actual =
        new JsonMapper()
            .readValue(response.getContentAsString(), new TypeReference<Map<String, String>>() {});
    assertThat(actual).containsAllEntriesOf(result);
    verify(context.cqlService)
        .executePreparedStatement(any(), eq("CALL NodeOps.getReplication(?)"), eq("ks1"));
  }
  ...
  public void testCreateTable() throws Exception {
    ...
    List<Column> columns =
        ImmutableList.of(
            ...
            new Column(
                "v",
                "frozen<list<tuple<int,map<string,string>,udt>>>",
                ColumnKind.REGULAR,
                0,
                null),
    ...
    MockHttpRequest request =
        MockHttpRequest.post(ROOT_PATH + "/ops/tables/create")
    ...
    verify(context.cqlService)
        .executePreparedStatement(
            ...
            eq(
                ImmutableMap.of(
                    "option2", ImmutableMap.of("option2a", "value2a", "option2b", "value2b"))));
  }
  ...
  public void testCreateTableInvalid() throws Exception {
    ...
    List<Pair<CreateTableRequest, String>> testCases =
        ImmutableList.of(
            Pair.of(
                new CreateTableRequest("", "table1", ImmutableList.of(), null),
                "Table creation failed: 'keyspace_name' must not be empty"),
            Pair.of(
                new CreateTableRequest("ks1", "", ImmutableList.of(), null),
                "Table creation failed: 'table_name' must not be empty"),
            Pair.of(
                new CreateTableRequest("ks1", "table1", ImmutableList.of(), null),
            ...
            Pair.of(
                new CreateTableRequest(
                    ...
                    ImmutableList.of(
                        ...
                        new Column("pk", "int", ColumnKind.REGULAR, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    "ks1",
                    "table1",
                    ImmutableList.of(new Column("", "int", ColumnKind.PARTITION_KEY, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    "ks1",
                    "table1",
                    ImmutableList.of(new Column("pk", "", ColumnKind.PARTITION_KEY, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    "ks1",
                    "table1",
                    ImmutableList.of(new Column("pk", "list<", ColumnKind.PARTITION_KEY, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    "ks1",
                    "table1",
                    ImmutableList.of(new Column("pk", "int", null, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    "ks1",
                    "table1",
                    ImmutableList.of(new Column("pk", "int", ColumnKind.PARTITION_KEY, -1, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    ...
                    ImmutableList.of(
                        new Column("pk", "int", ColumnKind.PARTITION_KEY, 0, null),
                        new Column("cc", "int", ColumnKind.CLUSTERING_COLUMN, -1, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    ...
                    ImmutableList.of(
                        new Column("pk", "int", ColumnKind.PARTITION_KEY, 0, null),
                        new Column("cc", "int", ColumnKind.CLUSTERING_COLUMN, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    "ks1",
                    "table1",
                    ImmutableList.of(new Column("pk", "int", ColumnKind.REGULAR, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    ...
                    ImmutableList.of(
                        new Column("pk1", "int", ColumnKind.PARTITION_KEY, 0, null),
                        new Column("pk2", "int", ColumnKind.PARTITION_KEY, 0, null)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    ...
                    ImmutableList.of(
                        new Column("pk", "int", ColumnKind.PARTITION_KEY, 0, null),
                        new Column(
                            "cc", "int", ColumnKind.CLUSTERING_COLUMN, 1, ClusteringOrder.ASC)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    ...
                    ImmutableList.of(
                        new Column("pk", "int", ColumnKind.PARTITION_KEY, 0, null),
                        new Column(
                            "cc1", "int", ColumnKind.CLUSTERING_COLUMN, 0, ClusteringOrder.ASC),
                        new Column(
                            "cc2", "int", ColumnKind.CLUSTERING_COLUMN, 0, ClusteringOrder.ASC)),
                    null),
            ...
            Pair.of(
                new CreateTableRequest(
                    "ks1",
                    "table1",
                    ImmutableList.of(new Column("pk", "int", ColumnKind.PARTITION_KEY, 0, null)),
            ...
            Pair.of(
                new CreateTableRequest(
                    ...
                    ImmutableList.of(new Column("pk", "int", ColumnKind.PARTITION_KEY, 0, null)),
                    ImmutableMap.of(
                        "option1", ImmutableMap.of("option1a", "value1a", "option1b", 123))),
