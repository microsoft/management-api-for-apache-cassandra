...
public class CompactRequest implements Serializable {
  ...
  public CompactRequest(
      @JsonProperty("split_output") boolean splitOutput,
      @JsonProperty("user_defined") boolean userDefined,
      @JsonProperty("start_token") String startToken,
      @JsonProperty("end_token") String endToken,
      @JsonProperty("keyspace_name") String keyspaceName,
      @JsonProperty("user_defined_files") List<String> userDefinedFiles,
  ...
  public int hashCode() {
    return Objects.hash(
        splitOutput, userDefined, startToken, endToken, keyspaceName, userDefinedFiles, tables);
  }
}
