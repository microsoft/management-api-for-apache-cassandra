...
import org.apache.cassandra.locator.K8SeedProviderHcd;
...
import org.apache.cassandra.transport.UnixSocketServerHcd;
import org.apache.cassandra.utils.FBUtilities;
import org.apache.cassandra.utils.JVMStabilityInspector;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class CassandraAPIHcd implements CassandraAPI {
  private static final Logger logger = LoggerFactory.getLogger(CassandraAPIHcd.class);

  private static final Supplier<SeedProvider> seedProvider =
      Suppliers.memoize(() -> new K8SeedProviderHcd());
  ...
  public ChannelInitializer<Channel> makeSocketInitializer(
    ...
    return UnixSocketServerHcd.makeSocketInitializer(connectionTracker);
  }
  ...
  public List<Map<String, String>> getEndpointStates() {
    ...
    for (InetAddressAndPort endpoint : Gossiper.instance.getEndpoints()) {
      ...
      states.put("ENDPOINT_IP", endpoint.getAddress().getHostAddress());
