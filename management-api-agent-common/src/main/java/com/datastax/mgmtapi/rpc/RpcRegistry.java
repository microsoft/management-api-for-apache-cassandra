...
/**
 * Keeps track of RPC objects, which in turn keep track of their methods, which handle the actual
 * serialization. Also contains the parsing code, although that should be fixed at some point.
 */
public class RpcRegistry {
  protected static final ConcurrentHashMap<String, RpcObject> objects = new ConcurrentHashMap<>();

  /**
   * For statics, just use any object of the right type. Method.invoke() will simply ignore the
   * object parameter.
   */
